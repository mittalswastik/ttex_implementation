...
7. ``sudo ninja -j4`` - ``-jn``, n is number of threads used to build llvm (more n results in faster build but slower linking)
8. ``../binutils/configure --enable-gold --enable-plugins --disable-werror``
9. ``make all-gold``
