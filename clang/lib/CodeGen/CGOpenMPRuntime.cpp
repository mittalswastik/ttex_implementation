...
void CGOpenMPRuntime::emitParallelCall(CodeGenFunction &CGF, SourceLocation Loc,
  ...
  auto &&ThenGen = [&M, OutlinedFn, CapturedVars, RTLoc,
    ...
    llvm::Value *Args[] = {
        ...
        CGF.Builder.getInt32(parallel_id_ctr) //swastik: add id here (added)
    };
    ...
    llvm::MDNode* parallel_id_value = llvm::MDNode::get(context, llvm::ValueAsMetadata::get(set_parallel_id_value));
    OutlinedFn->setMetadata("parallel_id", parallel_id_value);
    parallel_id_ctr++;
...
static void emitForStaticInitCall(
  ...
  //llvm::Value *sub_parallel_id = llvm::ConstantInt::get(llvm::IntegerType::getInt32Ty(CGF.getLLVMContext()),0, false);
  ...
  llvm::ConstantInt *id_val = llvm::ConstantInt::get(llvm::IntegerType::getInt32Ty(C),0, false);
